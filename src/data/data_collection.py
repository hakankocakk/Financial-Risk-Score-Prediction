...
def data_split(dataframe: pd.DataFrame, size_params: dict):
    ...
    try:
        train, temp = train_test_split(dataframe,
                                       test_size=size_params["val_test_size"],
                                       random_state=42)
        validation, test = train_test_split(temp,
                                            test_size=size_params["test_size"],
                                            random_state=42)
